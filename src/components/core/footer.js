  ...
  return (
    ...
    <footer className="bg-white dark:bg-gray-800">
        <div className="container px-6 py-8 mx-auto">
            ...
            <a href="/" className="text-2xl font-bold text-gray-800 dark:text-white hover:text-gray-700 dark:hover:text-gray-300">{site.siteMetadata.title}</a>
            ...
            <div className="flex flex-col mt-4 sm:flex-row sm:items-center sm:justify-center">
                ...
                <button className="w-full px-5 py-2 text-sm tracking-wide text-white capitalize transition-colors duration-200 transform bg-indigo-600 rounded-md sm:mx-2 sm:order-2 sm:w-auto hover:bg-indigo-500 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-80">Get started</button>
            </div>
            </div>
